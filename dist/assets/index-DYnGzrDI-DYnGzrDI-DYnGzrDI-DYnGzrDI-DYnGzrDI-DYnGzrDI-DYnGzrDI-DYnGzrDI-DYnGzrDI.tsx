import PredictionImg01 from '@/assets/images/ResearchArea/Prediction/prediction1.png'
import PredictionImg02 from '@/assets/images/ResearchArea/Prediction/prediction2.png'
...
const Prediction = () => {
  return (
    <section id="prediction" className="max-w-7xl mx-auto mt-40">
      <h2 className="text-3xl sm:text-5xl font-bold text-center mb-24">MOBILITY PREDICTION & DEMAND FORECAST</h2>
      ...
      <ResearchProject subSectionTitle="Demand Forecast for Bike Sharing Systems"
                       ...
                       subSectionAnno={null}
                       subSectionImg={PredictionImg01}
                       cardList={[
                                  {title:"Improving short-term bike sharing demand forecast through an    irregular convolutional neural network",
                                        journal:"Transportation Research Part C: Emerging Technologies",
                                        imageFront:"src/assets/images/ResearchArea/Prediction/prediction_p1.png",
                                        imageBack:"src/assets/images/JournalCovers/TRC.jpg",
                                  ...
                                  {title:"Short-Term Forecast of Bicycle Usage in Bike Sharing Systems: A Spatial-Temporal Memory Network",
                                    ...
                                    imageFront:"src/assets/images/ResearchArea/Prediction/prediction_p3.png",
                                    imageBack:"src/assets/images/JournalCovers/ITS.png",
                                  ...
                                  {title:"Unravel the landscape and pulses of cycling activities from a dockless bike-sharing system",
                                    ...
                                    imageFront:"src/assets/images/ResearchArea/Prediction/prediction_p4.png",
                        ...
                        videoList={[
                                    {year: 2018,
                                    title:"Shared Bikes",
                                    imageFront:"src/assets/images/ResearchArea/Prediction/prediction_shared_bikes.png",
                                    youTubeLink:"https://www.youtube.com/watch?v=_yfiuV4j9Jw",
                                    bilibiliLink:"https://www.bilibili.com/video/BV1ii4y1R7of/?vd_source=97a695383c4b98a4ed8b80d5fdecc716",
                                    tencentLink:"https://v.qq.com/x/page/a0798qotoie.html?",
                                    type:"video",
                                    text:""
                                    }
                        ]}
          ...
          <ResearchProject subSectionTitle="Movement Predictability of Urban Tourists"
                       ...
                       cardList={[
                                  {title:"Understanding the movement predictability of international travelers using a nationwide mobile phone dataset collected in South Korea",
                                        journal:"Computers, Environment and Urban Systems",
                                        imageFront:"src/assets/images/ResearchArea/Prediction/prediction_p2.png",
                                        imageBack:"src/assets/images/JournalCovers/CEUS.jpg",
                        ...
                        videoList={[
                                    ...
                                    year:2022,
                                    title:"Urban Tour",
                                    imageFront:"src/assets/images/ResearchArea/Prediction/prediction_urban_tour.png",
                                    youTubeLink:"https://www.youtube.com/watch?v=_yfiuV4j9Jw",

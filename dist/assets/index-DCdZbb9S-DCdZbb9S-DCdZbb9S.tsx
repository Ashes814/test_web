...
const ProjectCard = ({cardList, coverCard}:ProjectCardProps) => {
  return (
    <div id="featured-articles" className="mb-12 sm:mb-0">
      <h4 className='text-xl font-bold text-gray-50 bg-polyu-primary w-[280px] sm:w-[250px] text-center rounded-lg mb-4'>FEATURED ARTICLES</h4>
...
const ProjectVideo = ({videoList, type}: ProjectVideoProps) => {
  return (
    <div id="project-video" className="mb-12 sm:mb-0">
      <h4 className='text-xl 
                     font-bold text-gray-50 bg-polyu-primary text-center w-[280px] sm:max-w-[220px] rounded-lg mb-4'>
    ...
    <>
      <div className="hidden sm:block"> 
        <div className="mb-32 flex flex-col items-start">
          ...
          {(cardList.length + videoList.length > 2) ? (       
          <div className="p-8 pl-0 border-b-4 border-polyu-primary border-dashed">
            ...
            <div className='flex flex-row justify-center items-start gap-6 text-lg pl-0 mb-16'>
              ...
              <div className="flex-1 rounded-lg overflow-hidden shadow-lg"><img src={new URL(`/${subSectionImg}`, import.meta.url).href} alt="PredictionImg01" className="w-full"/></div>
            </div>
            {/* Cards */}
            ...
            <div className="flex flex-col justify-center items-center p-8 pl-0 border-b-4 border-polyu-primary border-dashed">
              ...
              {/* Bottom Image */}
              <div className="w-[80%] flex justify-center items-center rounded-lg overflow-hidden shadow-lg"><img src={new URL(`/${subSectionImg}`, import.meta.url).href} alt="PredictionImg01" className=""/></div>
            </div>
          )}
      ...
      <div className="block sm:hidden">
        <div className="mb-32 flex flex-col justify-center items-center max-w-lg mx-auto">
          {/* Sub section title */}
          <div id="project-head" className='flex flex-col justify-between items-center w-full mb-4'>
            <p className="text-lg font-bold">{year}</p>
            <h3 className="border-b-4 border-polyu-primary text-xl font-bold text-left" >{subSectionTitle}</h3>
          </div>

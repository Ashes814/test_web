...
<div className="w-screen overflow-x-clip">
    <div className="flex flex-col justify-center items-center mt-24 mb-24" >
      <section id="leader" className="mt-20 mb-48 flex flex-col justify-center items-center gap-24 ">
        <div className="h-full flex flex-col justify-between items-start gap-16 mx-auto max-w-xs sm:flex-row sm:max-w-5xl lg:max-w-6xl" 
        >
          ...
          variants={{
            ...
            <div className="flex flex-row justify-center items-center sm:gap-4 px-0 w-full text-[0.6rem] sm:text-xs lg:text-sm">
        ...
        <motion.div className="flex flex-col justify-center items-start gap-12 max-w-xs sm:max-w-5xl lg:max-w-6xl mx-auto font-thin sm:flex-row" 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 1 }}

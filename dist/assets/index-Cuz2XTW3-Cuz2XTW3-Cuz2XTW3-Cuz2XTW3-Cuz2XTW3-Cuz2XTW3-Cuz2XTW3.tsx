...
>
    <div className="flex flex-col justify-center items-center mt-24 mb-24 overflow-x-hidden sm:overflow-x-visible" >
      <section id="leader" className="mt-20 mb-48 flex flex-col justify-center items-center gap-24 ">
        <div className="h-full flex flex-col justify-between items-start gap-16 mx-auto max-w-xs sm:flex-row sm:max-w-6xl" 
        >
          ...
          variants={{
            ...
            <div className="flex flex-row justify-center items-center sm:gap-4 px-0 w-full text-[0.6rem] sm:text-sm">
                ...
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://scholar.google.com/citations?user=97A-qAoAAAAJ&hl=en" target='_blank'>
                  <img src={GSLogo} alt="Google Scholar" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                ...
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://www.researchgate.net/profile/Yang-Xu-36" target='_blank'>
                  <img src={RGLogo} alt="ResearchGate" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>ResearchGate</p>
                </motion.a>
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://orcid.org/0000-0003-3898-022X" target='_blank'>
                  <img src={ORCIDLogo} alt="ORCID" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>ORCID</p>
                </motion.a>
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://x.com/_Yang_Xu" target='_blank'>
                  <img src={XLogo} alt="x" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>Twitter/X</p>
                </motion.a>
            </div>
          </motion.div>
        ...
        <motion.div className="flex flex-col justify-center items-start gap-12 max-w-xs md:max-w-6xl mx-auto font-thin sm:flex-row" 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 1 }}

...
const publications = [
    ...
    {id: 61,
      ...
      {id: 69,
        title: "Striking a balance between diversity and regularity: apreference-guided transformer for individual mobilityprediction.",
        authors: "Li, G., Xu, Y., Gui, Z., Guo, X., and Tang, L.",
        journal: "International Journal of Geographical Information Science, 1–32.",
        year: 2025,

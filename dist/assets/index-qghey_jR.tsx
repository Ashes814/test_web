...
import LKLogo from "@/assets/Logos/lk.png"
      ...
      <section id="leader" className="mt-20 mb-48 flex flex-col justify-center items-center gap-24 ">
        ...
        >
          ...
          variants={{
            ...
            <div>
              ...
              <div className="flex flex-col gap-0 p-0">              
                  ...
                  <p className="text-sm md:text-lg font-bold">Department of Land Surveying and Geospatial Science</p>
          ...
          variants={{
            ...
            <div className="flex flex-row justify-center items-center md:gap-4 px-0 w-full text-[0.6rem] md:text-xs lg:text-sm">
                ...
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://www.linkedin.com/in/yang-xu-308b9a9a/" target='_blank'>
                  <img src={LKLogo} alt="LinkedIn" className="w-[30px] md:w-[50px] h-[30px] md:h-[50px]"/>
                  <p>LinkedIn</p>
                </motion.a>
            </div>
          </motion.div>
        ...
        <motion.div className="flex flex-col justify-center items-start gap-12 max-w-xs sm:max-w-3xl md:max-w-5xl lg:max-w-6xl mx-auto font-thin sm:flex-row" 
          ...
          <div className="flex flex-1 flex-col justify-center items-center">
              ...
              <ul className="text-sm md:text-base list-disc pl-6 flex flex-col gap-4">
                <li>Associate Professor, Department of Land Surveying and Geospatial Science, The Hong Kong Polytechnic University (2023 - Present)</li>
                <li>Assistant Professor, Department of Land Surveying and Geospatial Science, The Hong Kong Polytechnic University (2017 - 2023)</li>

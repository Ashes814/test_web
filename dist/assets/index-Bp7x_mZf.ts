...
const news = [
    ...
    {id:11,
      ...
      {id:23,
        ...
        contents: "Dr. Yang Xu was invited by HKIS to deliver a talk titled \"Geospatial Intelligence for Smart Urban Mobility\". During the session, he showcased the lab's latest work in geospatial AI, including models for forecasting transport demand and enhancing smart tourism. He also introduced a recently completed urban simulation model designed to optimize fleet size and parking locations for shared autonomous vehicles (SAVs) in cities.",
        date: "Apr 2026",
        site: "HKIS",

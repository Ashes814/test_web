...
const ProjectCard = ({cardList, coverCard}:ProjectCardProps) => {
  return (
    <div id="featured-articles" className="mb-12 sm:mb-0">
      ...
      <div className="flex flex-col sm:flex-row justify-start items-start gap-6 flex-wrap">    
          {cardList.map((card) => {
            return (
              <Cards 
                    key={card.title}
...
const ResearchProject = ({subSectionTitle, 
  ...
  return (
    <>
      ...
      {/* Large Screen */}
      <div className="hidden sm:hidden lg:block lg:max-w-7xl lg:mx-auto"> 
        <div className="mb-32 flex flex-col items-start">
          ...
          <div className="p-8 pl-0 border-b-4 border-polyu-primary border-dashed">
            ...
            <div className="flex flex-col justify-center items-center p-8 pl-0 border-b-4 border-polyu-primary border-dashed">
              ...
              {/* Bottom Image */}
              <div className="w-[80%] flex justify-center items-center rounded-lg overflow-hidden"><img src={new URL(`/${subSectionImg}`, import.meta.url).href} alt="PredictionImg01" className=""/></div>
            </div>
          )}
      ...
      {/* In Ipad */}
      <div className="hidden sm:block sm:max-w-5xl sm:mx-auto lg:hidden"> 
        <div className="mb-32 flex flex-col items-start">
          {/* Sub section title */}
          <div id="project-head" className='flex flex-row justify-between items-center w-full mb-4'>

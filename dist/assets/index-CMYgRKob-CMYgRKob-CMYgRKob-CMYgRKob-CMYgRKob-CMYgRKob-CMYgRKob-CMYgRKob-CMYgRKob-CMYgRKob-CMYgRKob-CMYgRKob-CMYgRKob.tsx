...
const Prediction = () => {
  return (
    <section id="prediction" className="max-w-7xl mx-auto mt-40">
      <h2 className="text-2xl sm:text-5xl font-bold text-center mb-24">MOBILITY PREDICTION & DEMAND FORECAST</h2>
      ...
      <ResearchProject subSectionTitle="Demand Forecast for Bike Sharing Systems"
                       ...
                       subSectionAnno={null}
                       subSectionImg={"src/assets/images/ResearchArea/Prediction/prediction1.png"}
                       cardList={[
          ...
          <ResearchProject subSectionTitle="Movement Predictability of Urban Tourists"
                       ...
                       subSectionAnno={null}
                       subSectionImg={"src/assets/images/ResearchArea/Prediction/prediction2.png"}
                       cardList={[

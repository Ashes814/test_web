...
>
    <div className="flex flex-col justify-center items-center mt-24 mb-24" >
      <section id="leader" className="mt-20 mb-48 flex flex-col justify-center items-center gap-24 ">
        <div className="h-full flex flex-col justify-between items-start gap-16 mx-auto max-w-sm sm:flex-row sm:max-w-6xl" 
        >
        ...
        <motion.div className="flex flex-col justify-center items-start gap-12 max-w-sm md:max-w-6xl mx-auto font-thin sm:flex-row" 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 1 }}

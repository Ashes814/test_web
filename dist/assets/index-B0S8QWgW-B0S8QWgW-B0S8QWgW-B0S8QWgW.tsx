...
const Tourism = () => {
  return (
    <section id="tourism" className="max-w-7xl mx-auto mt-40">
      <h2 className="text-3xl sm:text-5xl font-bold text-center mb-24">TOURIST MOBILITY & SMART TOURISM</h2>

 


      <ResearchProject subSectionTitle="A Cross-Scale Representation of Tourist Activity Space"
                       subSectionText="We present a conceptual framework designed to capture the spatial dynamics of tourist activities through a cross-scale perspective. The framework takes tourists’ accommodation locations as key reference points to map the organization of tourists' movements across varying spatial scales and the allocation of their time budgets. It conceptualizes a tourist’s itinerary as a combination of long-distance travels due to changes of accommodations, and localized movements within the vicinity of each accommodation location. The cross-scale approach of our framework offers a more comprehensive understanding of the spatial and temporal organization of tourist activity spaces, providing a systematic typology of tourist activity spaces and a hierarchical measurement of spatial extents and time budgets. Furthermore, this framework is adaptable to broader human movement studies that incorporate hierarchical structures, making it a versatile tool for understanding human spatial dynamics."
                       subSectionAnno={null}
                       subSectionImg="src/assets/images/ResearchArea/tourism/cross_scale.png"
                       cardList={[
                                  {title:"A Cross-Scale Representation of Tourist Activity Space",
                                        journal:"Annals of the American Association of Geographers",
                                        imageFront:"src/assets/images/ResearchArea/tourism/cross_scale_paper01_front.png",
                                        imageBack:"src/assets/images/ResearchArea/tourism/cross_scale_paper01_back.png",
                        ...
                        coverCard={{
                          coverImage:"/src/assets/images/JournalCovers/AAG.jpg",
                          link: "https://www.tandfonline.com/doi/full/10.1080/24694452.2023.2231533"
                        }}
                        year={"2022 - 2023"}
                                />
      <ResearchProject subSectionTitle="Tourist Mobility Profiling"
                       ...
                       subSectionAnno={null}
                       subSectionImg="src/assets/images/ResearchArea/tourism/tourist_mobility.png"
                       cardList={[
                                  {title:"Towards a multidimensional view of tourist mobility patterns in cities: A mobile phone data perspective",
                                        journal:"Computers, Environment and Urban Systems",
                                        imageFront:"src/assets/images/ResearchArea/tourism/tourist_mobility_paper01_front.png",
                                        imageBack:"src/assets/images/ResearchArea/tourism/tourist_mobility_paper01_back.png",
                        ...
                        coverCard={{
                          coverImage:"src/assets/images/JournalCovers/CEUS.jpg",
                          link: "https://doi.org/10.1016/j.compenvurbsys.2020.101593"
                        }}
                        year={"2020 - 2021"}
                                />
      <ResearchProject subSectionTitle="Understanding Tourist Time Use"
                       ...
                       cardList={[
                                  {title:"Tourism Geography through the Lens of Time Use: A Computational Framework Using Fine-Grained Mobile Phone Data",
                                        journal:"Annals of the American Association of Geographers",
                                        imageFront:"src/assets/images/ResearchArea/tourism/tourist_time_paper01_front.png",
                                        imageBack:"src/assets/images/ResearchArea/tourism/tourist_time_paper01_back.png",
...
<ResearchProject subSectionTitle="Tourism Network"
                       ...
                       subSectionAnno={null}
                       subSectionImg="src/assets/images/ResearchArea/tourism/tourism_network.jpg"
                       cardList={[
                                  {title:"Characterizing destination networks through mobility traces of international tourists — A case study using a nationwide mobile positioning dataset",
                                        ...
                                        imageFront:"src/assets/images/ResearchArea/tourism/tourism_network_paper01_front.png",
                                        imageBack:"src/assets/images/JournalCovers/TM.jpg",
                        ...
                        videoList={[
                                    ...
                                    imageFront:"src/assets/images/ResearchArea/tourism/2020_tourism_network.png",

...
const Connectivity = () => {
  return (
    ...
    <h2 className="text-3xl sm:text-5xl font-bold text-center mb-24">CITIES, SOCIETY & CONNECTIVITY</h2>

    <ResearchProject subSectionTitle="Quantifying Urban Social Segregation"
                     ...
                     subSectionAnno={null}
                     subSectionImg="src/assets/images/ResearchArea/connectivity/social_segregation.png"
                     cardList={[
                                {title:"Quantifying segregation in an integrated urban physical-social space",
                                      journal:"Journal of The Royal Society Interface",
                                      imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_paper01_front.png",
                                      imageBack:"src/assets/images/JournalCovers/RSI.png",
                                ...
                                {title:"Beyond Distance Decay: Discover Homophily in Spatially Embedded Social Networks",
                                      ...
                                      imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_paper02_front.png",
                                ...
                                {title:"Aggravated social segregation during the COVID-19 pandemic: Evidence from crowdsourced mobility data in twelve most populated U.S. metropolitan areas",
                                      ...
                                      imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_paper03_front.png",
                                      imageBack:"src/assets/images/JournalCovers/SCS.jpg",
                      ...
                      videoList={[
                        {year: 2019,
                          ...
                          imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_video01.png",
                          youTubeLink:"https://senseable.mit.edu/singapore-calling/",
                          bilibiliLink:"",
                          tencentLink:"",
                          type: "website",
                          text: "Joint research with MIT Senseable City Lab"
                          },
                        {year: 2019,
                          title:"Conquer the Divided Cities",
                          imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_video02.png",
                        ...
                        {year: 2022,
                          ...
                          imageFront:"src/assets/images/ResearchArea/connectivity/social_segregation_video03.png",
    ...
    <ResearchProject subSectionTitle="Inclusive Public Open Space for All"
                     ...
                     subSectionAnno={null}
                     subSectionImg="src/assets/images/ResearchArea/connectivity/public.jpg"
                     cardList={[
                                {title:"Inclusive public open space for all: Spatial justice with health considerations",
                                      journal:"Habitat International",
                                      imageFront:"src/assets/images/ResearchArea/connectivity/public_paper01_front.jpg",
                                      imageBack:"src/assets/images/ResearchArea/connectivity/public_paper01_back.png",
                      ...
                      coverCard={{
                        coverImage:"src/assets/images/JournalCovers/HI.jpg",
                        link: "https://doi.org/10.1016/j.habitatint.2021.102457"
                      }}
                      year={"2020 – 2021"}
                              />

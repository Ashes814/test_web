...
import LeaderIMG from "@/assets/LeaderIMG.jpeg"
...
>
    <div className="flex flex-col justify-center items-center mt-24 mb-24" >
      <section id="leader" className="mt-20 mb-48 flex flex-col justify-center items-center gap-24 ">
        <div className="h-full flex flex-col justify-between items-start gap-16 mx-auto max-w-lg sm:flex-row sm:max-w-6xl" 
        >
          <motion.div className="flex flex-col flex-1 justify-between items-start gap-8 xs:px-16 md:border-r p-0" 
          initial="hidden"
          whileInView="visible"
          ...
          variants={{
            ...
            <div>
              <h4 className="text-xl sm:text-2xl font-bold mb-2">Yang Xu</h4>

              <div className="flex flex-col gap-0 p-0">              
                  <p className="text-sm sm:text-lg font-bold">Associate Professor</p>
                  <p className="text-sm sm:text-lg font-bold">Department of Land Surveying and Geo-Informatics</p>
                  <p className="text-xs sm:text-base font-thin">The Hong Kong Polytechnic University</p>
                  <p className="text-xs sm:text-base font-thin">181 Chatham Road South, Hung Hom, Kowloon, Hong Kong</p>
          ...
          variants={{
            ...
            <div className="flex flex-row justify-center items-center sm:gap-4 px-0 w-full text-xs sm:text-sm">
                ...
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://scholar.google.com/citations?user=97A-qAoAAAAJ&hl=en" target='_blank'>
                  <img src="src/assets/Logos/gs.png" alt="Google Scholar" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>Google Scholar</p>
                </motion.a>
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://www.researchgate.net/profile/Yang-Xu-36" target='_blank'>
                  <img src="src/assets/Logos/rg.png" alt="ResearchGate" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>ResearchGate</p>
                </motion.a>
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://orcid.org/0000-0003-3898-022X" target='_blank'>
                  <img src="src/assets/Logos/orcid.png" alt="ORCID" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>ORCID</p>
                </motion.a>
                <motion.a whileHover={{scale: 1.2}} className="flex-1 flex flex-col justify-center items-center font-bold gap-2" href="https://x.com/_Yang_Xu" target='_blank'>
                  <img src="src/assets/Logos/x.png" alt="x" className="w-[30px] sm:w-[50px] h-[30px] sm:h-[50px]"/>
                  <p>Twitter/X</p>
                </motion.a>
            </div>
          </motion.div>
        ...
        <motion.div className="flex flex-col justify-center items-start gap-12 max-w-lg md:max-w-6xl mx-auto font-thin sm:flex-row" 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          transition={{ duration: 1 }}
          ...
          <div className="flex flex-1 flex-col justify-center items-center sm:pl-12">
            <h4 className="text-xl sm:text-2xl text-center font-thin mb-8 border-b-2 px-5">Education</h4>
            <div>
              <ul className="text-sm sm:text-base list-disc pl-6 flex flex-col gap-4">
          ...
          <div className="flex flex-1 flex-col justify-center items-center">
              <h4 className="text-xl sm:text-2xl text-center font-thin  mb-8 border-b-2 px-10">Professional Positions</h4>
              <ul className="text-sm sm:text-base list-disc pl-6 flex flex-col gap-4">
      ...
      <section id="alumni member">
        ...
        variants={{
          ...
          <h4 className="text-xl sm:text-4xl font-bold text-center mb-6">Alumni</h4>
           {/* Doctoral Student */}
          <div className='mb-12'>
            <p className="text-lg sm:text-2xl font-thin text-center mb-4">Doctoral Student</p>
            <ul className="flex flex-col justify-start items-start gap-6 text-center">
            
            {alumnis.filter((alumni) => {
              return alumni.type === "Doctoral Student"
            }).map((alumni) => {
              return (
                <AlumniMember {...alumni} />
              )
